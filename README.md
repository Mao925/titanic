...
| Random Forest | 初期（特徴量追加：FamilySize, IsAlone, IsChild） 
 ...
 |
| Gradient Boosting | モデル変更・ハイパーパラメータ調整（lr=0.1, max_depth=4等） 

 | 0.8328 

 |
| Gradient Boosting | Age補完改善＋HasCabin＋TicketGroupSize追加 

 | 0.8362 

 |
| Gradient Boosting | さらにDeck特徴量を追加 

 | 0.8373 

 |
| **XGBoost** | Deck・HasCabin・TicketGroupSizeを活用しGridSearch実行 
